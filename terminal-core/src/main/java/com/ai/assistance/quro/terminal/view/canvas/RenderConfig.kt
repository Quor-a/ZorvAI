...
data class RenderConfig(
    val fontSize: Float = 42f, // 默认字体大小（物理像素）；Compose 包装层会按 sp 换算传入
    ...
    val lineSpacing: Float = 0.12f, // 行间距（相对于字符高度的比例）
    ...
    val paddingLeft: Float = 12f,
    val paddingTop: Float = 8f,
    val paddingRight: Float = 12f,
    val paddingBottom: Float = 8f
) {
