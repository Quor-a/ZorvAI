package com.ai.assistance.quro.terminal.data
...
data class TerminalSessionData(
    ...
    val title: String,
    val terminalSession: com.ai.assistance.quro.terminal.TerminalSession? = null,
    val pty: com.ai.assistance.quro.terminal.Pty? = null, // PTY 对象，用于获取终端模式
