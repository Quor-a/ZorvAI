...
object QuroTtsProviders {
    ...
    private val OPENAI : QuroTtsProviderDef = QuroTtsProviderDef(
        ...
        voices = listOf(
            QuroTtsVoice("alloy", "Alloy", lang = "英文"), QuroTtsVoice("echo", "Echo", lang = "英文"),
            QuroTtsVoice("fable", "Fable", lang = "英文"), QuroTtsVoice("onyx", "Onyx", lang = "英文"),
            QuroTtsVoice("nova", "Nova", lang = "英文"), QuroTtsVoice("shimmer", "Shimmer", lang = "英文"),
            QuroTtsVoice("coral", "Coral", lang = "英文"), QuroTtsVoice("sage", "Sage", lang = "英文"),
            QuroTtsVoice("ballad", "Ballad", lang = "英文"), QuroTtsVoice("verse", "Verse", lang = "英文"),
            QuroTtsVoice("marin", "Marin", lang = "英文"), QuroTtsVoice("cedar", "Cedar", lang = "英文"),
            QuroTtsVoice("ash", "Ash", lang = "英文"),
        ),
        streamingSupport = true,
        cloneSupport = false,
        providerTags = listOf(),
