...
import com.ai.assistance.quro.genui.app.websearch.net.AntiBot
import com.ai.assistance.quro.genui.app.websearch.net.EngineHealth
...
object SearchDiagnostics {
    ...
    suspend fun diagnose(
        ...
        val ranked = if (merged.isNotEmpty()) {
            com.ai.assistance.quro.genui.app.websearch.rank.ResultReranker.rerank(
