    ...
    private fun seed(): List<QuroPersona> {
        ...
        return listOf(
            QuroPersona(
                ...
                voiceProfile = QuroVoiceProfile(providerId = "edge", voiceId = "zh-CN-XiaoxiaoNeural", emotionEnabled = false, emotionTags = emptyList(), speed = 1.0f),
            ...
            QuroPersona(
                ...
                voiceProfile = QuroVoiceProfile(providerId = "edge", voiceId = "zh-CN-XiaoxiaoNeural", emotionEnabled = true, emotionTags = listOf("gentle"), speed = 0.95f),
